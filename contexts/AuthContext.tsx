...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // FIXED: Wrap fetchUser in useCallback to stabilize reference
  ...
  }, []); // No dependencies needed as it only uses setUser/setLoading

  // Fetch current user on mount
  useEffect(() => {
    fetchUser();
  }, [fetchUser]); // FIXED: Include fetchUser in dependency array
