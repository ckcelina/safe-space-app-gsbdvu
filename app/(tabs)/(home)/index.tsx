      ...
      >
        ...
        <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
          <View style={styles.container}>
            ...
            {/* Add Person Modal - FIXED: Always renders content */}
            <SwipeableModal
            ...
            {/* Add Topic Modal - FIXED: Always renders content */}
            <SwipeableModal
...
const styles = StyleSheet.create({
  ...
  cards: {
    gap: 12Now I can see the issue! Looking at the code in `index.tsx`, both modals are wrapped in `KeyboardAvoider` components. The problem is that `KeyboardAvoider` has `flex: 1` in its container style, which can cause layout issues inside modals. When the keyboard state changes or certain conditions occur, the content can collapse or not render.

The fix is to ensure that:
1. The modal content always renders regardless of any state
2. Remove any conditional rendering that might hide content
3. Ensure the KeyboardAvoider doesn't interfere with the modal's layout

Let me examine the current structure more carefully and fix the issue:
      ...
      >
        ...
        <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
          <View style={styles.container}>
            ...
            >
              <View style={styles.modalContentWrapper}>
                <KeyboardAvoider style={styles.modalKeyboardAvoider}>
                  <View style={styles.modalContent}>
                    <View style={styles.modalHeader}>
                      <Text style={[styles.modalTitle, { color: theme.textPrimary }]}>Add Person</Text>
                      <TouchableOpacity onPress={handleCloseModal} style={styles.closeButton}>
